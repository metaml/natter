(() => {
            ...
            appendRecord: function(v) {
              return function(ra) {
                return function(rb) {
                  ...
                  return insert10(append13(get5(ra))(get5(rb)))(tail2);
                };
              };
            }
          };
            ...
            return function(array) {
              function go2(bot, top2) {
                switch (top2 - bot) {
                  ...
                  case 2:
                    return apply4(map30(array2)(f(array[bot])))(f(array[bot + 1]));
                  case 3:
                    return apply4(apply4(map30(array3)(f(array[bot])))(f(array[bot + 1])))(f(array[bot + 2]));
                  default:
                    var pivot = bot + Math.floor((top2 - bot) / 4) * 2;
                    return apply4(map30(concat2)(go2(bot, pivot)))(go2(pivot, top2));
                }
              }
  ...
  var foldM = function(dictMonad) {
    ...
    return function(f) {
      return function(z) {
        return _foldM(bind16)(f)(pure17(z));
      };
    };
  };
                  ...
                  return {
                    convertHelper: function(v) {
                      return function(r) {
                        ...
                        var head3 = convertImpl1($$Proxy.value)(get5($$Proxy.value)(r));
    ...
    return function(p2) {
      return makeAff(function(cb) {
        return voidRight2(mempty2)(thenOrCatch3(function(a2) {
          return map11(resolve3)(cb(new Right(a2)));
        })(function(e) {
  ...
  var toAbortableAff = function(abortController) {
    return function(p2) {
      return makeAff(function(cb) {
        return function __do2() {
          $$void5(thenOrCatch4(function(a2) {
            return map13(resolve4)(cb(new Right(a2)));
          })(function(e) {
  ...
  var fetch2 = function() {
    return function() {
      return function(dictToCoreRequestOptions) {
        ...
        return function(url2) {
          return function(r) {
            return bind4(liftEffect4($$new4(url2)(convert3(r))))(function(request3) {
              return bind4(liftEffect4(newImpl3))(function(abortController) {
                var signal2 = signal(abortController);
                return bind4(bindFlipped5(toAbortableAff(abortController))(liftEffect4(fetchWithOptions2(request3)({
                  signal: signal2
                }))))(function(cResponse) {
  ...
  var encodeJson2 = /* @__PURE__ */ encodeJson(/* @__PURE__ */ encodeRecord(/* @__PURE__ */ gEncodeJsonCons(/* @__PURE__ */ encodeJsonArray(/* @__PURE__ */ encodeRecord(/* @__PURE__ */ gEncodeJsonCons2(/* @__PURE__ */ gEncodeJsonCons2(gEncodeJsonNil)(roleIsSymbol)())(contentIsSymbol)())()))(/* @__PURE__ */ gEncodeJsonCons(encodeJsonJBoolean)(gEncodeJsonNil)({
    reflectSymbol: function() {
      return "stream";
    }
  })())(messagesIsSymbol)())());
  var gDecodeJsonCons2 = /* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(decodeJsonString));
  var decodeJson2 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeArray2(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons2(gDecodeJsonNil)(roleIsSymbol)()())(contentIsSymbol)()())())))(gDecodeJsonNil)(messagesIsSymbol)()())({
    reflectSymbol: function() {
      return "friend";
    }
  })()())());
  ...
  var talk = function(req) {
    return bind5(fetch3("http://localhost:8000/talk")({
      ...
      return bind5(res.json)(function(json3) {
    ...
    return function(dictIsSymbol) {
      ...
      return function(dictOrd) {
        ...
        return function(slot5) {
          return function(label5) {
            return function(req) {
              return $$void7(query22(slot5)(label5)(req(unit)));
            };
          };
        };
      };
    ...
    return function(dictIsSymbol) {
      ...
      return function(dictOrd) {
        ...
        return function(slot5) {
          return function(label5) {
            return function(req) {
              return query22(slot5)(label5)(req(identity10));
            };
          };
        };
      };
          ...
          return {
            foldlRecordRowList: function(f) {
              return function(x) {
                return function(v) {
                  return function(r) {
                    return foldlRecordRowList1(f)(foldingWithIndex1(f)($$Proxy.value)(x)(get5($$Proxy.value)(r)))($$Proxy.value)(r);
                  };
                };
              };
            }
  ...
  var map110 = /* @__PURE__ */ map(functorObject);
  ...
  var mkFieldResults1 = function(dictHFoldlWithIndex) {
    return {
      mkFieldResults: function() {
        var $267 = map19(flip(build)({}));
        var $268 = hfoldlWithIndex(dictHFoldlWithIndex)(MkFieldResult.value)(pure6(identity12));
        return function($269) {
          return $267($268($269));
        };
      }(),
  ...
  var mkFieldOutputs1 = function(dictHFoldlWithIndex) {
    return {
      mkFieldOutputs: function() {
        var $270 = map19(flip(build)({}));
        var $271 = hfoldlWithIndex(dictHFoldlWithIndex)(MkFieldOutput.value)(pure6(identity12));
        return function($272) {
          return $270($271($272));
        };
      }(),
              ...
              return function(prop3) {
                return function(rin) {
                  return function(field) {
                    var v1 = from2(field);
                    return apply2(map19(composeFlipped2)(rin))(map19(insert13(prop3))(v1.result));
                  };
                };
              };
            }
              ...
              return function(prop3) {
                return function(rin) {
                  return function(field) {
                    ...
                    return apply2(map19(composeFlipped2)(rin))(map19(insert13(prop3))(hush(result)));
                  };
                };
              };
            }
      ...
      return function(validators) {
        return function(v) {
          ...
          if (v instanceof Validate) {
            return pure12(new Just(v.value1(validate$prime(v.value0)(validators))));
          }
          ;
                ...
                return function(initialForm) {
                  return function(component3) {
                    ...
                    var modifyField = function(v) {
                      return function(object2) {
                        var field = unsafeIndex2(object2)(v.type);
                        return insert(v.type)(v.value(field))(object2);
                      };
                    };
                    ...
                    var runValidation = function(fieldKey) {
                      return bind7(bindFlipped6(function() {
                      ...
                      if (v instanceof HandleForm && v.value0 instanceof Eval) {
                        if (v.value0.value0 instanceof SubmitForm) {
                          return discard2(for_1(v.value0.value0.value0)(function(event) {
                            ...
                            return discard2(bind7(get3)(function(v1) {
                              return for_22(getKeys(v1.fieldObject))(runValidation);
                            }))(function() {
                              return bind7(get3)(function(v1) {
                        ...
                        if (v.value0.value0 instanceof ResetForm) {
                          ...
                          return discard2(modify_3(function(state3) {
                            ...
                            ;
                            $239.fieldObject = map110(reset2)(state3.fieldObject);
                            $239.formState = {
                              submitCount: 0,
                              errorCount: 0,
                              allTouched: false
                    ...
                    return mkComponent({
                      ...
                      render: function(state3) {
                        ...
                        return slot2($$Proxy.value)(unit)(component3)(context)(HandleForm.create);
                      },
                      "eval": mkEval({
  ...
  var unsafeReadProp = function(dictMonad) {
    ...
    return function(k) {
      return function(value12) {
        return unsafeReadPropImpl(fail2(new TypeMismatch2("object", typeOf(value12))), pure17, k, value12);
      };
    };
  };
  ...
  var mkComponent2 = function(dictShow) {
    var show3 = show(dictShow);
    return function(title3) {
      return function(descr) {
        return function(formComponent) {
          var render5 = function(state3) {
            return article_([h3_([text3(title3)]), p_([text3(descr)]), slot3($$Proxy.value)(unit)(formComponent)(unit)(identity13), function() {
              if (state3.result instanceof Nothing) {
                return text3("");
              }
              ;
              if (state3.result instanceof Just) {
                return code_([text3(show3(state3.result.value0))]);
              }
              ;
              throw new Error("Failed pattern match at Html (line 31, column 38 - line 33, column 89): " + [state3.result.constructor.name]);
            }()]);
          };
          var action3 = function(result) {
  ...
  var logShow2 = /* @__PURE__ */ logShow(showRecord1);
  var logShow1 = /* @__PURE__ */ logShow(/* @__PURE__ */ showRecord2(/* @__PURE__ */ showRecordFieldsCons({
    reflectSymbol: function() {
      return "content";
    }
  ...
  var render = function(v) {
    var texts = map21(function(v1) {
      return text3(v1.name + (": " + v1.message));
    })(v.messages);
    var container = class_("container");
    var articles = map21(function(text8) {
      return article([container])([text8]);
    })(texts);
    return form([onSubmit(v.context.formActions.handleSubmit)])([div_([label_([]), ul_(articles)]), div_([label_([]), input([type_4(InputText.value), onValueInput(v.context.actions.message.handleChange), onBlur(v.context.actions.message.handleBlur), function() {
      if (v.context.fields.message.result instanceof Nothing) {
        return placeholder("message");
      }
      ;
      if (v.context.fields.message.result instanceof Just && v.context.fields.message.result.value0 instanceof Left) {
        return attr2("aria-invalid")("true");
      }
      ;
      if (v.context.fields.message.result instanceof Just && v.context.fields.message.result.value0 instanceof Right) {
        return attr2("aria-invalid")("false");
      }
      ;
      throw new Error("Failed pattern match at Chat (line 115, column 34 - line 118, column 98): " + [v.context.fields.message.result.constructor.name]);
      ...
      ;
      if (v.context.fields.name.result instanceof Just && v.context.fields.name.result.value0 instanceof Left) {
        return attr2("aria-invalid")("true");
      }
      ;
      if (v.context.fields.name.result instanceof Just && v.context.fields.name.result.value0 instanceof Right) {
        return attr2("aria-invalid")("false");
      }
      ;
      throw new Error("Failed pattern match at Chat (line 125, column 34 - line 128, column 98): " + [v.context.fields.name.result.constructor.name]);
  ...
  var query4 = function(dictMonadAff) {
    ...
    var validation2 = {
      name: function(v) {
        if (v === "") {
          return new Left("a name is required");
        }
        ;
        return new Right(v);
      },
      message: function(v) {
        if (v === "") {
          return new Left("a message is required");
        }
        ;
        return new Right(v);
      }
    ...
    var onSubmit2 = function(fields) {
      return bind8(get4)(function(state$prime) {
        return discard3(modify_5(function(v) {
          var $161 = {};
          for (var $162 in v) {
          ...
          ;
          $161.messages = append12(state$prime.messages)([{
          ...
          return discard3(liftEffect10(logShow2(fields)))(function() {
            return discard3(liftEffect10(logShow1(msg)))(function() {
              return bind8(liftAff2(talk(req)))(function(v) {
                ...
                if (msg$prime instanceof Just) {
                  ...
                  return discard3(liftEffect10(logShow2(rec)))(function() {
                    return bind8(get4)(function(state3) {
                      return modify_5(function(v1) {
                        ...
                        ;
                        $166.messages = append12(state3.messages)([rec]);
                        return $166;
                      });
                    });
                  });
                ...
                ;
                throw new Error("Failed pattern match at Chat (line 81, column 9 - line 89, column 63): " + [msg$prime.constructor.name]);
              });
            });
          });
        });
  ...
  var action = function(dictMonadEffect) {
    return function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Chat (line 57, column 10 - line 59, column 45): " + [v.constructor.name]);
    };
  };
  var form2 = /* @__PURE__ */ function() {
    return formless(monadEffectAff)(mkFieldStates1(hmapRecord()(mapRecordWithIndexCons2(constMapping2)(mapRecordWithIndexCons1(constMapping2)(mapRecordWithIndexNil)()())()())))(mkFieldActions1(hmapWithIndexRecord()(mapRecordWithIndexCons2(mappingWithIndexMkFieldAc(messageIsSymbol)(refl)())(mapRecordWithIndexCons1(mappingWithIndexMkFieldAc(nameIsSymbol)(refl)())(mapRecordWithIndexNil)()())()())))(mkFieldResults1(hfoldlRecordWithIndex2(foldlRecordCons2(foldingWithIndexMkFieldRe(messageIsSymbol)(refl)()())(foldlRecordCons1(foldingWithIndexMkFieldRe(nameIsSymbol)(refl)()())(foldlRecordNil)))))(mkFieldOutputs1(hfoldlRecordWithIndex2(foldlRecordCons2(foldingWithIndexMkFieldOu(messageIsSymbol)(refl)()())(foldlRecordCons1(foldingWithIndexMkFieldOu(nameIsSymbol)(refl)()())(foldlRecordNil)))))(mkConfig1(defaultsRecord()()))({
      ...
      "eval": mkEval({
        initialize: defaultEval.initialize,
        finalize: defaultEval.finalize,
        receive: function($178) {
          return Just.create(Receive3.create($178));
        },
  ...
  var component = /* @__PURE__ */ mkComponent2(showRecord1)("chat")("")(form2);
  ...
  var selectElement = function(query5) {
    return bind9(liftEffect5(bindFlipped7(composeKleisliFlipped4(function() {
  ...
  var render2 = function(innerComponent) {
  ...
  var evalQ = function(render5) {
    return function(ref2) {
      return function(q2) {
        return bind12(liftEffect6(read(ref2)))(function(v) {
          return evalM(render5)(ref2)(v["component"]["eval"](new Query(map24(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
            ...
            if (v1 instanceof Subscribe) {
              return bind12(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind12(liftEffect6(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind12(liftEffect6(read(ref2)))(function(v2) {
                    return discard1(liftEffect6(modify_(map25(insert9(sid)(finalize)))(v2.subscriptions)))(function() {
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element3) {
        return bind14(liftEffect8(map28(toDocument)(bindFlipped10(document)(windowImpl))))(function(document2) {
  ...
  var foldHashes = function(cb) {
    return function(init3) {
      return function __do2() {
        var ref2 = bindFlipped11($$new)(bindFlipped11(init3)(getHash))();
        var win = map29(toEventTarget)(windowImpl)();
        var listener = eventListener(function(v) {
          return bindFlipped11(flip(write)(ref2))(join3(apply3(map29(cb)(read(ref2)))(getHash)));
        })();
  ...
  var modify7 = /* @__PURE__ */ modify4(monadStateHalogenM);
  ...
  var renderStoryNames = function(v) {
    return function(items2) {
      ...
      return ul([class_2("Storybook-nav-list")])(mapFlipped2(sortWith2(function(v1) {
        ...
        }()), href("#" + fromJust5($$encodeURIComponent(item.path)))])([text3(item.name)])]);
      }));
    };
  };
  var renderSidebar = function(stories) {
    return function(state3) {
      ...
      return div3([class_2("Storybook-nav")])(mapFlipped2(sorted)(function(v) {
        ...
        ;
        return div3([class_2("Storybook-nav-section")])([div3([class_2("Storybook-nav-section-title")])([text3(v.value0)]), renderStoryNames(state3)(v.value1)]);
      }));
    };
  };
  ...
  var renderMain = function(stories) {
    return function(state3) {
      var v = lookup(state3.route)(stories);
      if (v instanceof Just) {
        return slot4(_child2)(state3.route)(v.value0)(unit)(absurd);
      }
      ;
      return div_([h2_([text3("Hello world")]), p_([text3("This site is powered by "), a([href("https://github.com/rnons/purescript-halogen-storybook")])([text3("halogen-storybook")]), text3(".")])]);
    };
  };
  var render3 = function(v) {
    return function(state3) {
      return div3([class_2("Storybook")])([a([class_2("Storybook-logo"), href("#")])([function() {
        if (v.logo instanceof Nothing) {
          return text3("Halogen Storybook");
        }
        ;
  ...
  var runStorybook = function(config) {
    return function(body4) {
      return bind15(runUI2(app(config))(unit)(body4))(function(app$prime) {
        return void1(liftEffect9(hashes(function(v) {
  ...
  var render4 = /* @__PURE__ */ article_([/* @__PURE__ */ h3_([/* @__PURE__ */ text3("ami")]), /* @__PURE__ */ p_([/* @__PURE__ */ text3("ami operations")])]);
  ...
  var main2 = /* @__PURE__ */ function() {
    var stories = fromFoldable2(foldableArray)([new Tuple("", proxy(component2)), new Tuple("chat", proxy(component))]);
    return runHalogenAff(bind(bindAff)(awaitBody)(runStorybook({
      stories,
      logo: new Just(text3("ami"))
    })));
  }();
